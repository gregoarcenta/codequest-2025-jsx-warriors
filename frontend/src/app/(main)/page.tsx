...
import HeroMascot from "@/components/blog/HeroMascot";
...
export default function MainHome() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-purple-900 via-indigo-900 to-slate-900 text-white py-24 overflow-hidden">
