...
Este proyecto utiliza variables de entorno para su configuración. Se necesitará crear y configurar un archivo `.env` en
ambos proyectos `frontend` y `backend`..

1. **Crear los archivos `.env`:**
   Copia los archivo de ejemplo proporcionados para crear los archivos de configuración.
    ```sh
...
2. **Configurar tus variables:**
   Abre el archivo `backend/.env` y `frontend/.env` que acabas de crear y edita las variables de entorno necesarias (por
   ejemplo,
...
| Variable                                                                  | Descripción                                                                                                                         | Valores y Notas de Configuración                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|:--------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| `BACKEND_URL`                                                             | URL del api del backend.                                                                                                            | En desarrollo, usa **`http://localhost:3000`**.                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `DISCORD_CLIENT_ID`<br>`DISCORD_CLIENT_SECRET`                            | Claves de la API de Discord para autenticación social.                                                                              | Para que el login funcione, ve al **[Discord Developer Portal](https://discord.com/developers/applications)**, selecciona tu aplicación y navega a la pestaña **`OAuth2`**. Dentro de la sub-pestaña **`Redirects`**, añade el siguiente URL: `http://localhost:3000/api/auth/discord/callback`. <br> **Nota:** Esta URL es un **endpoint** del backend. Discord envía el código de autorización a este endpoint para que tu servidor lo procese y complete la autenticación. Es vital que esta URL coincida exactamente. |
| `CLOUDINARY_NAME`<br>`CLOUDINARY_API_KEY`<br>`CLOUDINARY_API_SECRET`      | Credenciales de Cloudinary para la gestión de imágenes.                                                                             | En el panel de control de tu cuenta de **[Cloudinary](https://cloudinary.com/console/dashboard)**, encontrarás el "Cloud name", la "API Key" y el "API Secret".                                                                                                                                                                                                                                                                                                                                                           |
...
| `NEXT_PUBLIC_API_URL`                                                     | **Única para el frontend.**<br> URL base del backend a la que el frontend hará las peticiones.                                      | En desarrollo, usa **`http://localhost:3000/api`**.                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `NEXT_PUBLIC_API_URL_DOCKER`                                              | **Única para el frontend en Docker.**<br> URL base del backend a la que el frontend hará las peticiones dentro de la red de Docker. | **`http://backend:3000/api`**<br> **Nota: Si no se usa Docker, el valor de NEXT_PUBLIC_API_URL_DOCKER debe ser el mismo que el de NEXT_PUBLIC_API_URL**                                                                                                                                                                                                                                                                                                                                                                   |
...
### Usuarios por Defecto para Acceso

Durante la inicialización, la aplicación crea dos usuarios por defecto en la base de datos para facilitar las pruebas y
el desarrollo. Puedes usarlos para acceder y probar las funcionalidades de la plataforma de inmediato.
