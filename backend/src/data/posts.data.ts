...
export const POST_DATA: Partial<Post>[] = [
  {
    ...
    coverImageUrl:
      'https://images.unsplash.com/photo-1628157503708-4e38c385c7d8',
  ...
  },
  {
    ...
    coverImageUrl:
      'https://images.unsplash.com/photo-1633356122587-f8319f39d1ae',
    status: PostStatus.PUBLISHED,
    isFeatured: false,
    viewsCount: 500,
  ...
  },
  {
    ...
    coverImageUrl:
      'https://images.unsplash.com/photo-1618413156689-f54817a5223c',
    status: PostStatus.PUBLISHED,
    isFeatured: false,
    viewsCount: 250,
  ...
  },
  {
    ...
    coverImageUrl: 'https://images.unsplash.com/photo-1549241517-c4667d4f40f0',
    status: PostStatus.PUBLISHED,
    isFeatured: false,
    viewsCount: 600,
